...
public class RegistrationEmail implements EmailService {
    ...
    public void sendSimpleMessage(String to) {
        ...
        try {
            ...
            helper.setText(createEmailBody(to.replace("@gmail.com", "")), true); // Set to true to indicate HTML content
    ...
    private String createEmailBody(String username) {
        return "<html>" +
                ...
                "<a href=\"http://localhost:8080/api/auth/activate?token=" + "token" + "\">Activate Account</a>" +
