...
class AuthServiceTest {
    ...
    void activateUser_ThrowsUserNotFoundException_WhenUserNotExists() {
        ...
        assertThrows(UserNotFoundException.class, () -> authService.activateUser("testuser"));
        verify(userRepository).findByUsername("testuser", User.class);
    }
    ...
    @Test
    void authenticate_ThrowsAccountIsNotActivatedException_WhenAccountNotActivated() {
        userSecurity.setActivated(false);
        when(authentication.isAuthenticated()).thenReturn(true);
        when(authenticationManager.authenticate(any(UsernamePasswordAuthenticationToken.class))).thenReturn(authentication);
        when(userRepository.findByUsernameOrUserContactEmail(anyString(), anyString(), eq(User.class))).thenReturn(user);

        assertThrows(AccountIsNotActivatedException.class, () -> authService.login(loginRequest));
        verify(authenticationManager).authenticate(any(UsernamePasswordAuthenticationToken.class));
        verify(userRepository).findByUsernameOrUserContactEmail(anyString(), anyString(), eq(User.class));
    }

    @Test
    void authenticate_ReturnsLoginFailed_WhenAuthenticationFails() {
